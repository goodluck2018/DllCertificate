...
namespace CertificateService
{
    public class MySqlDBHelper
    {
        ...
        /// <returns></returns>
        public static DataTable Querry(string connectionString, string sql, params MySqlParameter[] parameters)
        {
            // "SERVER=47.103.37.8;DATABASE=dotnet;UID=root;PASSWORD=root;"
